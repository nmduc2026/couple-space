...
const SCREENS = [
  ...
  { name: 'goals', url: '/plan?preview=1&tab=goals', wait: 'Đà Lạt' },
  { name: 'goal-detail', url: '/plan/goals/g1?preview=1', wait: 'Đặt vé xe' },
  { name: 'expenses', url: '/expenses?preview=1', wait: 'Tổng chi' },
  { name: 'expense-new', url: '/expenses/new?preview=1', wait: 'Ghi một khoản' },
  { name: 'question', url: '/question?preview=1', wait: 'Câu hỏi mỗi ngày' },
  { name: 'mood', url: '/mood?preview=1', wait: 'ngày qua' },
