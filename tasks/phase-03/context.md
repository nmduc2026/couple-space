...
| 2026-09-15 | Chốt tầm nhìn mốc hệ thống: chỉ hôm nay → 31/12 năm nay (hết list “Kỉ niệm 9 năm”). Migration `20260929100000`, cập nhật `p3-events-reminders` + schema | Đã `db push` | Reload Kế hoạch kiểm tra |
