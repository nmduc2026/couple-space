...
- [x] **P6-07** Chạm vào một nơi → lọc Timeline theo nơi đó — tỉnh → **phường/xã** → địa điểm. Phường/xã có được nhờ nút "Lấy vị trí hiện tại" lúc soạn bài (tra ngược toạ độ qua OpenStreetMap); bài gõ tay gom vào nhóm "chưa rõ phường/xã" — chạm tỉnh mở danh sách địa điểm cụ thể trong tỉnh, chạm địa điểm mới lọc. Trước đây bản đồ trỏ `?place=` mà Timeline không hề đọc tham số đó nên **không lọc gì cả**
